...
- `cat-herramientas.jpg` ya no es una foto generada con IA — es una ILUSTRACIÓN propia (`tools/make_herramientas.py`, dibujada con PIL: gradientes metálicos, tablero verde pino, herrajes dorados) de un tablero de herramientas con una marca inventada ("FORZA"), no la marca real que distribuye el negocio. Se usa mientras no haya foto propia del inventario real. Confirmado con el negocio: sí distribuyen SATA.
